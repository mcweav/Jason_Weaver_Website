...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto mb-10 flex max-w-[1150px] flex-wrap items-center justify-center gap-5 px-4 sm:px-8 xl:px-0">
        <Link
          href="/resume"
      ...
      <div className="mx-auto grid max-w-[1150px] grid-cols-1 gap-4 px-4 sm:px-8 min-[860px]:grid-cols-[350px_1fr] xl:px-0">
        ...
        <div className="relative flex flex-col justify-between overflow-visible rounded-[28px] p-8 sm:p-10">
          ...
          <div className="flex justify-end gap-14 pt-2 pr-4 sm:gap-18 sm:pr-14">
            <div>
              <h4
